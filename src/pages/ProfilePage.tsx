...
function ProfilePage() {
    ...
    const BREWERY_API = `http://localhost:3000/breweries/owner/${user?.user_id}`
                ...
                <div className="mt-4">
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="relative">
                            ...
                            />
                            <button
                                className="absolute bottom-0 right-0 bg-yellow-500 rounded-full px-2 py-1 text-white hover:bg-yellow-400 transition duration-300 ease-in-out"
